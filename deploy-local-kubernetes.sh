...
kubectl apply -f manifests-local/deployment-test.yaml
...
kubectl apply -f manifests-local/nodeport-service.yaml
kubectl apply -f manifests-local/headless-svc.yaml